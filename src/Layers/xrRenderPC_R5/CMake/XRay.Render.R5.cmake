add_module(XRay.Render.R5.ForceIncludes INTERFACE)

target_compile_options(XRay.Render.R5.ForceIncludes
  INTERFACE
  $<$<CXX_COMPILER_ID:MSVC>:/FIr5.h>
  $<$<CXX_COMPILER_ID:Clang>:-includer5.h>
  $<$<CXX_COMPILER_ID:GNU>:-includer5.h>
)

add_module(XRay.Render.R5
  TYPE STATIC
...
add_module(XRay.Render.R5.3DFluid
  SOURCES
...
add_module(XRay.Render.R5.Core.Target
  SOURCES
...
add_module(XRay.Render.R5.DX9ToDX10Utils
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Application
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Console
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Debug
  SOURCES
  ../xrRender/DebugShader.h
)

add_module(XRay.Render.R5.Interfaces.Debug.Render
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Environment
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.FactoryPtr
  SOURCES
  ../xrRender/FactoryPtr.h
)

add_module(XRay.Render.R5.Interfaces.Font
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.ImGui
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.LensFlare
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.MSAA
  SOURCES
  ../xrRenderDX10/MSAA/dx10MSAABlender.cpp
  ../xrRenderDX10/MSAA/dx10MSAABlender.h
)

add_module(XRay.Render.R5.Interfaces.ObjectSpace
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Rain
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.RenderDevice
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.RenderFactory
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.StatGraph
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Stats
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.ThunderboltDesc
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.Thunderbolt
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.UI.Render
  SOURCES
  ../xrRender/UIRender.h
...
add_module(XRay.Render.R5.Interfaces.UI.SequenceVideoItem
  SOURCES
...
add_module(XRay.Render.R5.Interfaces.UI.Shader
  SOURCES
  ../xrRender/UIShader.h
...
add_module(XRay.Render.R5.Interfaces.WallMarkArray
  SOURCES
...
add_module(XRay.Render.R5.Lights
  SOURCES
  ../xrRender/light.cpp
  ../xrRender/light.h
...
add_module(XRay.Render.R5.Models
  SOURCES
  ../xrRender/ModelPool.cpp
  ../xrRender/ModelPool.h
)

add_module(XRay.Render.R5.Models.Visuals
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Backend
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.DebugDraw
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Gamma
  SOURCES
  ../xrRender/xr_effgamma.cpp
  ../xrRender/xr_effgamma.h
)

add_module(XRay.Render.R5.Refactored.Execution3D.Shaders.Blender
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Shaders.Resources
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Shaders.Resources.DX10RShader
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Shaders.Manager
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Visuals
  SOURCES
...
add_module(XRay.Render.R5.Refactored.Execution3D.Skeleton
  SOURCES
...
add_module(XRay.Render.R5.Refactored.HW
  SOURCES
  ../xrRenderDX12/dx12HW.cpp
  ../xrRender/HW.h
  ../xrRender/HWCaps.cpp
  ../xrRender/HWCaps.h
)

add_module(XRay.Render.R5.Refactored.Interfaces
  SOURCES
  ../xrRender/IRenderDetailModel.h
  ../xrRender/RenderDetailModel.h
)

add_module(XRay.Render.R5.Refactored.StatsManager
  SOURCES
  ../xrRender/stats_manager.cpp
  ../xrRender/stats_manager.h
)

add_module(XRay.Render.R5.ShadingTemplates
  SOURCES
...
add_module(XRay.Render.R5.StateManager
  SOURCES
...
add_module(XRay.Render.R5.Stripifier
  SOURCES
...
add_module(XRay.Render.R5.Utils
  SOURCES
  ../xrRender/Utils/dxHashHelper.cpp
  ../xrRender/Utils/dxHashHelper.h
)

add_module(XRay.Render.R5.Visibility.HOM
  SOURCES
  ../xrRender/HOM.cpp
  ../xrRender/HOM.h
...
add_module(XRay.Render.R5.Visibility.Sector
  SOURCES
...
add_module(XRay.Render.R5.Wallmarks
  SOURCES
  ../xrRender/WallmarksEngine.cpp
  ../xrRender/WallmarksEngine.h
)

target_compile_options(XRay.Render.R5
  PRIVATE
