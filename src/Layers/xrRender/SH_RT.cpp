...
//////////////////////////////////////////////////////////////////////////
// CRTC (cube render targets) is a DX10+-only facility, guarded out of this DX9/R2 unit by
// SH_RT.h's #if USE_DX10. The live implementation lives in xrRenderDX10/dx10SH_RT.cpp. (RND-01)
